...
const SProduct = () => {
  ...
  const [currentPage, setCurrentPage] = useState(1); // Set current page state
  const [productsPerPage] = useState(8); // Define how many products per page
  ...
  return (
    <div className="max-w-61 mx-auto px-4 py-8 ml-4">
      ...
      <div className='justify-center mt- 14 mb- 14 mx-auto text-center'>
